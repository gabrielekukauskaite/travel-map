const Label = () => {
  return (
    <div
      className="relative justify-self-center px-[14px] py-1 mt-2 mb-4 text-[#5a4a38] border border-black/40 rounded-[20px] font-serif font-medium text-[0.95rem] tracking-[0.08em] text-center whitespace-nowrap pointer-events-none"
      style={{
        background:
